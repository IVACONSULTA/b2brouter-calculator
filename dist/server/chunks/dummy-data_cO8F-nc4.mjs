...
const DUMMY_ANALYSIS_DETAIL = {
  ...
  rules: [
    {
      ...
      source_excerpt: "Each invoice transmission includes a submission and an acknowledgement, counted as 1.5 PA transactions per invoice.",
      confidence: "high",
      status: "proposed",
    ...
    },
    {
      ...
      source_document: "pricing_b2brouter_fr.pdf",
      source_excerpt: "Reception of e-invoices via the platform counts as 1 PA transaction per document received.",
      confidence: "high",
      status: "approved",
      manually_edited: false
    },
    {
      ...
      source_excerpt: "E-reporting batches are transmitted at 0.5 PA transactions per reported transaction due to grouping.",
      confidence: "medium",
      status: "proposed",
      manually_edited: false
    },
    {
      ...
      source_document: "guide_einvoicing_fr.docx",
      source_excerpt: "Received e-reporting status notifications are counted at 0.3 PA transactions each.",
      confidence: "medium",
    ...
    },
    {
      ...
      source_document: "pricing_b2brouter_fr.pdf",
      source_excerpt: "Payment reporting to the tax authority is billed at 0.2 PA transactions per payment event.",
      confidence: "low",
      status: "proposed",
    ...
    },
    {
      ...
      source_document: "pricing_b2brouter_fr.pdf",
      source_excerpt: "Credit notes and corrective documents are processed identically to invoices at 1.5 PA transactions.",
      confidence: "high",
      status: "rejected",
      manually_edited: false
    }
  ...
  ambiguities: [
    {
      id: "ambiguity-001",
      description: "Treatment of partial credit notes is not explicitly defined. Document §3.2 mentions 'corrective documents' but does not clarify if partial corrections follow the same 1.5× multiplier or a reduced rate.",
...
const DUMMY_ACTIVE_PROFILES = DUMMY_PROFILES.filter((p) => p.status === "active");
const DUMMY_ACTIVE_RULES = {
  "profile-fr-b2b-1": [
    { id: "rule-002", input_key: "issued_einvoicing", label: "Issued e-invoicing invoices/year", direction: "Issued", obligation: "E-invoicing", pa_transactions_per_item: 1.5, placeholder: 5e3 },
    { id: "rule-003", input_key: "received_einvoicing", label: "Received e-invoicing invoices/year", direction: "Received", obligation: "E-invoicing", pa_transactions_per_item: 1, placeholder: 2e3 },
    { id: "rule-004", input_key: "issued_ereporting", label: "Issued e-reporting transactions/year", direction: "Issued", obligation: "E-reporting", pa_transactions_per_item: 0.5, placeholder: 3e3 },
    { id: "rule-005", input_key: "received_ereporting", label: "Received e-reporting transactions/year", direction: "Received", obligation: "E-reporting", pa_transactions_per_item: 0.3, placeholder: 1e3 },
    { id: "rule-006", input_key: "payment_ereporting", label: "Payment e-reporting transactions/year", direction: "Issued", obligation: "Payment e-reporting", pa_transactions_per_item: 0.2, placeholder: 2e3 }
  ],
  "profile-de-sap-1": [
    { id: "rule-de-01", input_key: "issued_einvoicing", label: "Issued e-invoices/year (B2B domestic)", direction: "Issued", obligation: "E-invoicing", pa_transactions_per_item: 1, placeholder: 1e4 },
    { id: "rule-de-02", input_key: "received_einvoicing", label: "Received e-invoices/year (B2B domestic)", direction: "Received", obligation: "E-invoicing", pa_transactions_per_item: 0.8, placeholder: 5e3 },
    { id: "rule-de-03", input_key: "crossborder_issued", label: "Cross-border issued invoices/year", direction: "Issued", obligation: "E-reporting", pa_transactions_per_item: 0.5, placeholder: 2e3 },
...
const DUMMY_SCENARIO_RESULT = {
  ...
  created_by: "analyst@b2brouter.com",
  inputs: {
    issued_einvoicing: 8e3,
    received_einvoicing: 3e3,
    issued_ereporting: 2e3,
    received_ereporting: 1500,
    payment_ereporting: 5e3
  },
  transaction_breakdown: [
    { label: "Issued e-invoicing invoices", direction: "Issued", obligation: "E-invoicing", volume: 8e3, multiplier: 1.5, pa_transactions: 12e3 },
    { label: "Received e-invoicing invoices", direction: "Received", obligation: "E-invoicing", volume: 3e3, multiplier: 1, pa_transactions: 3e3 },
    { label: "Issued e-reporting transactions", direction: "Issued", obligation: "E-reporting", volume: 2e3, multiplier: 0.5, pa_transactions: 1e3 },
    ...
    { label: "Payment e-reporting", direction: "Issued", obligation: "Payment e-reporting", volume: 5e3, multiplier: 0.2, pa_transactions: 1e3 }
  ],
  total_pa_transactions: 17450,
  plan_comparison: [
    { plan_name: "Starter", annual_fee: 480, included: 2400, extra_cost: 0.2, extra_transactions: 15050, total_annual_cost: 3490, recommended: false },
    { plan_name: "Professional", annual_fee: 840, included: 6e3, extra_cost: 0.18, extra_transactions: 11450, total_annual_cost: 2901, recommended: false },
    { plan_name: "Enterprise", annual_fee: 1200, included: 12e3, extra_cost: 0.15, extra_transactions: 5450, total_annual_cost: 2017.5, recommended: true }
  ],
  recommended_plan: {
    plan_name: "Enterprise",
...
const DUMMY_SCENARIO_RESULT_2 = {
  ...
  transaction_breakdown: [
    { label: "Issued e-invoicing invoices", direction: "Issued", obligation: "E-invoicing", volume: 1e3, multiplier: 1.5, pa_transactions: 1500 },
    { label: "Received e-invoicing invoices", direction: "Received", obligation: "E-invoicing", volume: 400, multiplier: 1, pa_transactions: 400 },
  ...
  plan_comparison: [
    { plan_name: "Starter", annual_fee: 480, included: 2400, extra_cost: 0.2, extra_transactions: 0, total_annual_cost: 480, recommended: true },
    { plan_name: "Professional", annual_fee: 840, included: 6e3, extra_cost: 0.18, extra_transactions: 0, total_annual_cost: 840, recommended: false },
    { plan_name: "Enterprise", annual_fee: 1200, included: 12e3, extra_cost: 0.15, extra_transactions: 0, total_annual_cost: 1200, recommended: false }
  ],
  recommended_plan: {
    plan_name: "Starter",
    total_annual_cost: 480,
    annual_fee: 480,
    included_pa_transactions: 2400,
    extra_transaction_cost: 0.2,
...
export { DUMMY_ANALYSIS_DETAIL as D, DUMMY_ANALYSES as a, DUMMY_PROFILES as b, DUMMY_DOCUMENTS as c, DOCUMENT_TYPES as d, DUMMY_SCENARIOS as e, DUMMY_USERS as f, DUMMY_SCENARIO_RESULT as g, DUMMY_ACTIVE_RULES as h, DUMMY_ACTIVE_PROFILES as i, DUMMY_SCENARIO_RESULT_2 as j };
